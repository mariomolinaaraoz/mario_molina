...
const Featured = () => {
    ...
    const url = 'https://api.coingecko.com/api/v3/coins/markets?vs_currency=usd&ids=bitcoin%2C%20ethereum%2C%20binancecoin%2C%20tether%2C%20ravencoin%2C%20monero&order=market_cap_desc&per_page=100&page=1&sparkline=false'    
